...
function Header() {
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-300 bg-background/95 supports-[backdrop-filter]:bg-background/60 p-4 flex items-center justify-between">
